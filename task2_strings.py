...
game_name_top = video_game_sales[0][NAME]
game_year = video_game_sales[0][YEAR]
game_sales = video_game_sales[0][GLOBAL_SALES]

print(f"#1 Best Seller: {game_name_top} ({game_year}) - ${game_sales}M global sales")
